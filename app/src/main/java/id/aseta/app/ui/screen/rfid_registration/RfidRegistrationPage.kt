        ...
        Scaffold(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Select asset from the asset list to Register Tag RFID",
                        fontSize = 14.sp,
                                        ...
                                        modifier = Modifier
                                            ...
                                            .clickable {
                                                if (asset.rfid == null) {
                                                    ...
                                                    navController.navigate("rfid_registration_detail")
                                                } else {
                                                    Toast.makeText(
                                                        context,
                                                        "Data Asset memiliki RFID",
                                                        Toast.LENGTH_SHORT
                                                    ).show()
                                                }
                                            }
                                ...
                                items(filteredCategories) { category ->
                                    ...
                                    FindExpandableAssetItem(
                                        ...
                                        onClickItem = {
                                                it->
                                            if (it.rfid == null) {
                                                assetCategoryModel.assetDetail = it
                                                navController.navigate("rfid_registration_detail")
                                            } else {
                                                Toast.makeText(
                                                    context,
