...
//                        withContext(Dispatchers.IO) {
//                            while (isScanning) {
//                                val tag = mSled?.inventorySingleTag()
//                                if (tag != null) {
//                                    toneGenerator.startTone(ToneGenerator.TONE_PROP_BEEP, 100)
//                                    scannedRfid = tag.epc
//                                    UHFState.isScanning.value = false
            ...
            Box(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            "Change RFID for: ${manualInputAsset!!.nama_barang}",
                    ...
                    // Old RFID
                    OutlinedTextField(
                        value = manualInputAsset!!.rfid ?: "-",
                        onValueChange = {},
                        label = { Text("RFID Lama") },
                        modifier = Modifier.fillMaxWidth(),
                        enabled = false
                    )
                    ...
                    Button(
                        onClick = {
                            if (scannedRfid.isNotBlank() || scannedRfid != "") {
                                assetCategoryModel.updateRfid(
                                    context,
                                    scannedRfid,
                                    manualInputAsset!!
                                ){
                                    manualInputAsset!!.rfid  = scannedRfid
